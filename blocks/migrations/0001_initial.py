    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_path', models.FileField(blank=True, null=True, upload_to=blocks.models.get_image_path, verbose_name='путь к картинке')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_visible', models.BooleanField(db_index=True, default=1, verbose_name='показывать')),
                ('block_name', models.CharField(blank=True, max_length=80, verbose_name='название блока')),
                ('title', models.CharField(max_length=200, verbose_name='заголовок')),
                ('description', models.TextField(verbose_name='описание')),
                ('order_number', models.PositiveSmallIntegerField(default=0, verbose_name='порядковый номер')),
                ('svg_path', models.FileField(default='empty.svg', upload_to=blocks.models.get_svg_path, validators=[blocks.models.validate_svg_path], verbose_name='путь к svg файлу')),
            ],
            options={
